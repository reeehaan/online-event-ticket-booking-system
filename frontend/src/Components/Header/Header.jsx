...
const [currentUserType, setCurrentUserType] = useState(userType); // Fixed: renamed to avoid confusion
...
// Check authentication status and set user type
useEffect(() => {
...
// console.log('Getting nav items for user type:', currentUserType, 'isLoggedIn:', isLoggedIn);

switch (currentUserType) {
    case 'organizer':
        console.log('Returning organizer nav items');
        return organizerNavItems;
    case 'attendee':
        console.log('Returning attendee nav items');
        return attendeeNavItems;
    case 'guest':
    default:
        console.log('Returning guest nav items');
